...
Revised core syntax to ensure a strong base for data processing.
* **Concepts:** Dynamic typing, list methods (`append`), and basic function definitions.
* **Goal:** Understand how Python handles memory and basic collections.

## 📂 Day 2: Control Flow & Logic
Moved from static scripts to dynamic logic. 
* **Concepts:** Using `if-elif-else` for data validation and `for` loops for iteration.
* **Application:** Built a small logic gate to filter data points based on specific conditions.
